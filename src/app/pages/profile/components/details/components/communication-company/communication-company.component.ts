...
import { IResourceService } from '@ttt/common/interfaces';
import { BaseEditableList, ConfirmComponent, IEditorStatefulConfig, IEditorStateExt } from '@ttt/common';
import {
    CompanyCommunicationHistory, CallReason, Profile, CallReasonsService,
    CompanyContactsService, CompanyResourceService, Company,
} from '@ttt/core';
import { CommunicationCompanyConfig } from './communication-company.config';


@Component({
    selector: 'communication-company',
...
export class CommunicationCompanyComponent extends BaseEditableList<CompanyCommunicationHistory> implements OnInit {
    ...
    navigate(itemEdit: CompanyCommunicationHistory) {
