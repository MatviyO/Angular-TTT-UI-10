...
import {
  ...
  CompanyAffiliate, Company, Tools, HousingAllowance, Mentorship, WorkforceTrainingPersonal, WorkforceTrainingCompany, StudentGraduation,
  CompanyCommunicationHistory, NonPlacementReason, ScheduledClass, OrientationEvent, WithdrawReason, MilitaryBranch, EmploymentRecord, Rank,
} from '../model';
...
@Injectable()
export class EmploymentCompanyResourceService extends ResourceServiceBase<EmploymentRecord> {
  constructor(injector: Injector) {
...
@Injectable()
export class RankResourceService extends ResourceServiceBase<Rank> {
  constructor(injector: Injector) {
